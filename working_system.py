                    ...
                    <div class="card-header bg-transparent border-0 pt-4">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <a href="/custody" class="btn btn-outline-secondary">
                                <i class="fas fa-arrow-right me-1"></i>العودة لإدارة العهد
                            </a>
                    ...
                    <div class="card-header bg-transparent border-0 pt-4">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <a href="/invoices" class="btn btn-outline-secondary">
                                <i class="fas fa-arrow-right me-1"></i>العودة لإدارة الفواتير
                            </a>
                            <a href="/" class="btn btn-outline-success">
                                <i class="fas fa-home me-1"></i>الرئيسية
                            </a>
                    ...
                    <div class="card-header bg-transparent border-0 pt-4">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <a href="/licenses" class="btn btn-outline-secondary">
                                <i class="fas fa-arrow-right me-1"></i>العودة لإدارة التراخيص
                            </a>
                            <a href="/" class="btn btn-outline-success">
                                <i class="fas fa-home me-1"></i>الرئيسية
                            </a>
                    ...
                    <div class="card-header bg-transparent border-0 pt-4">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <a href="/support" class="btn btn-outline-secondary">
                                <i class="fas fa-arrow-right me-1"></i>العودة للدعم الفني
                            </a>
                            <a href="/" class="btn btn-outline-success">
                                <i class="fas fa-home me-1"></i>الرئيسية
                            </a>
...
<body>
    <div class="container mt-4">
        ...
        <div class="invoice-details">
            ...
            <p><strong>المبلغ:</strong> 5,000 ريال</p>
...
if __name__ == '__main__':
    ...
    print("📋 جميع الصفحات تحتوي على:")
    print("   - زر العودة للرئيسية")
    print("   - زر العودة للصفحة السابقة")
